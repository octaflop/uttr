...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PostPoll.entry'
        db.alter_column(u'polls_postpoll', 'entry_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forums.Reply']))

    def backwards(self, orm):

        # Changing field 'PostPoll.entry'
        db.alter_column(u'polls_postpoll', 'entry_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blog.BlogPost']))
