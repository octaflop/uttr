...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogPost.thread'
        db.add_column(u'blog_blogpost', 'thread',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blog.ForumThread'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogPost.thread'
        db.delete_column(u'blog_blogpost', 'thread_id')
    ...
    models = {
        ...
        u'blog.blogpost': {
            ...
            'thread': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['blog.ForumThread']", 'null': 'True', 'blank': 'True'}),
        ...
        u'blog.forumthread': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'topic_post': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['blog.BlogPost']"})
        },
        u'blog.modnotes': {
