...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModNotes.notes'
        db.add_column(u'blog_modnotes', 'notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ModNotes.mod'
        db.add_column(u'blog_modnotes', 'mod',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.UttrUser'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModNotes.notes'
        db.delete_column(u'blog_modnotes', 'notes')

        # Deleting field 'ModNotes.mod'
        db.delete_column(u'blog_modnotes', 'mod_id')
