...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BlogPost.source'
        db.delete_column(u'blog_blogpost', 'source_id')


    def backwards(self, orm):
        # Adding field 'BlogPost.source'
        db.add_column(u'blog_blogpost', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blog.Source'], null=True, blank=True),
                      keep_default=False)
