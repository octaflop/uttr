...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogPost.draft'
        db.add_column(u'blog_blogpost', 'draft',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'BlogPost.parent_post'
        db.add_column(u'blog_blogpost', 'parent_post',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blog.BlogPost'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogPost.draft'
        db.delete_column(u'blog_blogpost', 'draft')

        # Deleting field 'BlogPost.parent_post'
        db.delete_column(u'blog_blogpost', 'parent_post_id')
