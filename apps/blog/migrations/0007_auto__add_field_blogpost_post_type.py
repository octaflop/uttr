...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogPost.post_type'
        db.add_column(u'blog_blogpost', 'post_type',
                      self.gf('django.db.models.fields.CharField')(default='disc', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogPost.post_type'
        db.delete_column(u'blog_blogpost', 'post_type')
