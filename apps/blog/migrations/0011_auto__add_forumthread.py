...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'blog_forumthread', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('topic_post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blog.BlogPost'])),
        ))
        db.send_create_signal(u'blog', ['ForumThread'])


    def backwards(self, orm):
        # Deleting model 'ForumThread'
        db.delete_table(u'blog_forumthread')
